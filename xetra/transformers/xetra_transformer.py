...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_isn: column name for isin in target
    ...
    trg_key_date_formate: date format of target key file
    ...
    trg_key: str
    trg_key_date_formate: str
    trg_format: str

class XetraETL():
    """
    Reads the Xetra data, transforms and writes the transfomred to target
    """
